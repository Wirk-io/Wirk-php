...
class AppApi
{
     ...
     * 
     *
     * @return \Wirk\Model\AppReaderServiceModel[]
     ...
     * 
     *
     * @return Array of \Wirk\Model\AppReaderServiceModel[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Wirk\ApiException on non-2xx response
     */
    public function getAllWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Wirk\Model\AppReaderServiceModel[]'
            );
            ...
            return array(\Wirk\ObjectSerializer::deserialize($response, '\Wirk\Model\AppReaderServiceModel[]', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Wirk\ObjectSerializer::deserialize($e->getResponseBody(), '\Wirk\Model\AppReaderServiceModel[]', $e->getResponseHeaders());

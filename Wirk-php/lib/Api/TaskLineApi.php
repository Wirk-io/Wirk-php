...
class TaskLineApi
{
     ...
     * 
     *
     * @param \Wirk\Model\TaskLineWriterServiceModel $task_line_writer_service_model Taskline description (required)
     * @return \Wirk\Model\TaskLineReaderServiceModel
     * @throws \Wirk\ApiException on non-2xx response
     */
    public function post($task_line_writer_service_model)
    {
        list($response, $statusCode, $httpHeader) = $this->postWithHttpInfo ($task_line_writer_service_model);
        return $response; 
    }
     ...
     * @throws \Wirk\ApiException on non-2xx response
     */
    public function postWithHttpInfo($task_line_writer_service_model)
    {
        
        // verify the required parameter 'task_line_writer_service_model' is set
        if ($task_line_writer_service_model === null) {
            throw new \InvalidArgumentException('Missing the required parameter $task_line_writer_service_model when calling post');
        }
  
        // parse inputs
        $resourcePath = "/TaskLine";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        // body params
        $_tempBody = null;
        if (isset($task_line_writer_service_model)) {
            $_tempBody = $task_line_writer_service_model;
        }
